...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-19 05:06`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0b01c4b2-b9ab-40f7-b13e-5f3add30ee2f.git
$ cd 0b01c4b2-b9ab-40f7-b13e-5f3add30ee2f
```
